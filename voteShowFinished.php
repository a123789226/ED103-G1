...
try {
  ...
  // 哪些動物符合下列條件：找投投票結束時間<=今日，且命名審核狀態(nomStatus)為1(通過審核)，且通過的名字總數為6個的動物(總數小於6代表管理員少選名字或是根本沒選，總數大於6代表管理員不小心多選，避免意外要先排除)
  ...
  $sql = "SELECT a.aquaNo, a.aquaType, a.aquaPic, a.voteEnd, n.nomName, n.votedNum
          FROM aqua a JOIN nominate n ON (a.aquaNo = n.aquaNo) 
