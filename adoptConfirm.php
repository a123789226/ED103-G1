...
<body>
    <div class="adoptLightBox">
        ...
        <div class="adoptSection">
            ...
            <div class=\"adoptAqua\">
                <p>Your adopted aqua:</p><input type=\"text\" name=\"adoptedAqua\"
                    maxlength=\"20\" value=\"{$_POST["adoptedAqua"]}\">
                <img src=\"./image/journal/journal_dolphin/00.jpg\">
            </div>
            <!-- right adopt process -->
                    ...
                    <div class=\"adoptConfirmSection adoptTab tab4\">
                        ...
                        <div class=\"adoptConfirmCheck\">
                            <div class=\"adoptConfirm\">
                                <h5>Adopted Aqua</h5>
                                <input type=\"text\" value=\"{$_POST["adoptedAqua"]}\">
                            </div>

                            <div class=\"adoptConfirm\">
                                <h5>Adopt amount</h5>
                                <input type=\"text\" value=\"{$_POST["amountType"]}\">
                            </div>
                        </div>
                        ...
                        <div class=\"adoptConfirmCheck\">
                            <div class=\"adoptConfirm\">
                                ...
                                <div class=\"adoptInfo\">
                                    <p>Name</p>
                                    <input type=\"text\" placeholder=\"first name\" value=\"{$_POST["firstname"]}\">
                                    <input type=\"text\" placeholder=\"last name\" value=\"{$_POST["lastname"]}\">
                                </div>

                                <div class=\"adoptInfo\">
                                    <p>Email</p>
                                    <input type=\"text\" value=\"{$_POST["email"]}\">
                                    <h6 class=\"adoptReceipt\">*Your receipt will be emailed here</h6>
                                </div>

                                <div class=\"adoptInfo\">
                                    <p>Phone number</p>
                                    <input type=\"text\" value=\"{$_POST["phone"]}\">
                                </div>
                            ...
                            <div class=\"adoptConfirm\">
                                ...
                                <div class=\"adoptPayment\">
                                    <p>Name on card</p>
                                    <input type=\"text\" value=\"{$_POST["cardname"]}\">
                                </div>

                                <div class=\"adoptPayment\">
                                    <p>Card number</p>
                                    <input type=\"text\" value=\"{$_POST["cardnumber"]}\">
                                </div>

                                <div class=\"adoptPayment\">
                                    <p>Expiry date</p>
                                    <input type=\"text\" placeholder=\"MM/YY\" value=\"{$_POST["carddate"]}\">
                                </div>\

                                <div class=\"adoptPayment\">
                                    <p>Security code</p>
                                    <input type=\"number\" value=\"{$_POST["cardcode"]}\">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class=\"adoptProcessStep adoptProcessStepFinal\">
                            ...
                            <a href=\"./journal.html\" id=\"demo1\"><button class=\"adoptProcessBtn\"
                                    type=\"button\">ADOPT</button></a>
                        </div>
                    </div>
                </div>
            </div>
